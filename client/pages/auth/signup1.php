    ...
    <main>
        <section class="sections">
            <div class="containers">
                ...
                <div class="verify-otp-container" id="personalDetails">
                ...
                <!-- ==================== Select ID Form ==================== -->
                <div class="verify-otp-container hidden" id="selectId">
                    <form action="" id="selectIdForm">
                        <h3>Selection ID</h3>
                        <div class="inputs-container">
                ...
                <!-- ==================== Create Account Form ==================== -->
                <div class="verify-otp-container hidden" id="createAcc">
                    <form action="" id="createAccForm">
