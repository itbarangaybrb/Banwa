...
<body>
    ...
    <div id="signupModal" class="modal">
        <div class="modal-content">
            ...
            <div id="selectId" class="panel">Select ID Panel</div>
            <div id="personalDetails" class="panel hidden">Personal Details Panel</div>
            <div id="createAcc" class="panel hidden">Create Account Panel</div>
        </div>
    </div>
