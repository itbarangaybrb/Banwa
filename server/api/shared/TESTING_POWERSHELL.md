...
Invoke-RestMethod -Uri 'http://localhost:8080/server/api/shared/verify_ocr.php' -Method Post -Body $payload -ContentType 'application/json' -Headers @{ 'X-VERIFY-KEY' = 'YOUR_STRONG_KEY_HERE' }
